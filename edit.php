...
if($_SERVER["REQUEST_METHOD"] === "POST" && isset($_GET["productId"])) {
    ...
    $db->editProduct($productId, $productName, $productDescription, $productPrice,$productImage);
    $db->closeConnection();
}
...
<style>
    ...
    form label {
        font-size: 18px; /* Adjust label size for smaller screens */
    }
...
<body>
    ...
    <main>
    <form action="edit.php?productId=<?php echo $_GET["productId"]; ?>" method="post">
